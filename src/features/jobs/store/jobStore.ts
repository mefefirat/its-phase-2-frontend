...
import { fetchJobs, insertJob, updateJob, deleteJob, fetchJobById, fetchJobsList, fetchJobPackHierarchyRecursive, createJobScan, fetchJobPackages } from '../services/jobs';
...
interface JobState {
    ...
    fetchJobPackHierarchyRecursive: (jobId: string) => Promise<JobPackHierarchyNode[]>;
...
export const useJobStore = create<JobState>((set, get) => ({
    ...
    fetchJobPackHierarchyRecursive: async (jobId) => {
        try {
            const tree = await fetchJobPackHierarchyRecursive(jobId);
            set({ jobPackHierarchy: tree });
            return tree;
        } catch (error) {
